...
process.on('uncaughtException', pino.final(vocabot, (err: Error, finalLogger: Logger) => {
    finalLogger.error(err, 'uncaughtException')
    process.exit(1)
}));

// @ts-ignore
process.on('unhandledRejection', pino.final(vocabot, (err: Error, finalLogger: Logger) => {
